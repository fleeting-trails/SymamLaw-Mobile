...
const createStyles = ({ theme, color, size }: StyleType) => {
  return StyleSheet.create({
    container: {
      ...
      ...((!size || size === "medium") && { paddingVertical: 10, paddingHorizontal: 10 }),
      ...(size === "small" && { paddingVertical: 3, paddingHorizontal: 5 }),
      ...(size === "large" && { paddingVertical: 15, paddingHorizontal: 15 }),
      flexDirection: "row",
